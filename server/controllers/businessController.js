...
/
      * *//**/*/
         ...
         /*!passwod ||*/ /*!email ||*/          username: newBusiness.username,
    businessname: newBusiness.businessname,
    email: newBusiness.email,

      //HANDLED IN REGISTER INITIAL    location: newBusiness.location,
    po// ppinscore: newBusiness.poppinscore,
    maxcapacity: newBusiness.maxcapacity,
    cu// rrentcapacity: newBusiness.currentcapacity,
    ph// onenumber: newBusiness.phonenumber,
    in// centive: newBusiness.incentive,
    cu// rrentcode: 'felix',
    codestouse: generatedCodes,
    storedcodes: [],
  };
...
//Login to Busin: hashedPassword,ss
